    ...
    class Program
    {
        ...
        {   
            ...
            while (entry == "")
            {
                ...
                {
                    Console.WriteLine("Whoops, you must enter an integer.");
                    entry = "";
                }
            }
        ...
        static public void FindMax()
        {
            ...
            {
                correct = true;
                Console.WriteLine("Enter 5 integers separated by commas:");
                ...
                for (int i = 0; i < series.Length; i ++)
                {
                    ...
                    {
                        Console.WriteLine("That's not the entry we are looking for.");
                        correct = false;
                        break;
                    }
                }
